...
public class TilesLayout extends ViewGroup {
    ...
    public TilesLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.tiles);
        interval = (int) a.getDimension(R.styleable.tiles_interval, interval);
        sizeRatio = a.getFloat(R.styleable.tiles_sizeRatio, sizeRatio);
        scaleStep = a.getFloat(R.styleable.tiles_scaleStep, scaleStep);
        displayCount = a.getFloat(R.styleable.tiles_displayCount, displayCount);
        a.recycle();
